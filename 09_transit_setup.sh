...
vault write data_protection/transit/encrypt/customer-key plaintext=$(echo "my secret data" | base64)

vault write data_protection/transit/encrypt/archive-key plaintext=$(echo "my secret data" | base64)
